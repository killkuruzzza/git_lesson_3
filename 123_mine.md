...
Нажать в нужном для редактирования аккаунте на githud нужный респозиторий нопку fork. искомый респозиторий скопируется в шаш аккаунт. командой git clone... (указываем адрес скопиронного чужого респозитория форкнутого в наш аккаунт).
создаем отдельную ветку. вносим изменения. сохраняем изменния, согдаем свой коммит.
далее отправляем в свой аккаунт в гитхаб командой git pull
в нашем аккаунте с помощью команды pull request добавив описание изменений отправляем измененный респозиторий владельцу респозитория.
