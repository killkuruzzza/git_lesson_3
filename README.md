...
3. сохранить Файл "ctrl + S" (Также в программе можно настроить авто сохранение чтобы не нажимать постоянно ctrl + S )
...
6. для удаление слитой ветки git branch -d name (name название ветки) название ветки
#Переход
